    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @else
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('active-games') }}" :active="request()->routeIs('active-games')">
                        {{ __('Play Games') }}
                    </x-jet-nav-link>
                </div>
                @endif
                ...
                @if(auth()->user()->is_admin == 2)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('product-list.create') }}" >
                            {{ __('Add Product') }}
                        </x-jet-nav-link>
                    </div>
                @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/game/user/history" :active="request()->routeIs('game-history')">
                        {{ __('Game History') }}
                    </x-jet-nav-link>
                </div>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-blue-400 hover:text-blue-500 hover:bg-blue-100 focus:outline-none focus:bg-blue-100 focus:text-blue-500 transition duration-150 ease-in-out">
